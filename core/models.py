...
class Tire(models.Model):
    ...
    groove_1    = models.CharField("Sulco 1", max_length=10, blank=True)
    groove_2    = models.CharField("Sulco 2", max_length=10, blank=True)
    groove_3    = models.CharField("Sulco 3", max_length=10, blank=True)
    groove_4    = models.CharField("Sulco 4", max_length=10, blank=True)
